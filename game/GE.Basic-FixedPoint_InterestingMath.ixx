...
ge_int GE2_NOISE_SMOOTH_Q(GE2_Q_T ge2, ge_int seed)
{
    ...
    ge_int x_frac_Q16 = v_int.x - GE_WHOLE_Q<Q>(v_int.x);
    ge_int y_frac_Q16 = v_int.y - GE_WHOLE_Q<Q>(v_int.y);
    ...
    ge_int low_Q16;
    ge_int high_Q16;
    low_Q16 = GE_CUBIC_INTERP_1D_Q<Q>(GE_TO_Q<Q>(s), GE_TO_Q<Q>(t), x_frac_Q16);
    high_Q16 = GE_CUBIC_INTERP_1D_Q<Q>(GE_TO_Q<Q>(u), GE_TO_Q<Q>(v), x_frac_Q16);

    return GE_CUBIC_INTERP_1D_Q(low_Q16, high_Q16, y_frac_Q16);
}
